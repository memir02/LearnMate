        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.profileCard}>
            ...
            <View style={styles.profileInfo}>
              <Text style={styles.profileName}>Sistem Yöneticisi</Text>
          ...
          <View style={styles.menuGrid}>
            <MenuItem icon="👥" label="Kullanıcılar" color="#dbeafe" />
            <MenuItem icon="🏫" label="Sınıflar" color="#dcfce7" />
            <MenuItem icon="📋" label="Audit Loglar" color="#fef9c3" />
            <MenuItem icon="⚙️" label="Ayarlar" color="#fce7f3" />
            <MenuItem icon="📊" label="İstatistikler" color="#ede9fe" />
            <MenuItem icon="🔔" label="Bildirimler" color="#ffedd5" />
          </View>         
        </ScrollView>
      </SafeAreaView>
    </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  roleBadgeText: { fontSize: 12, fontWeight: '600', color: '#be185d' },
  sectionTitle: {
    fontSize: 16,
    fontWeight: '700',
