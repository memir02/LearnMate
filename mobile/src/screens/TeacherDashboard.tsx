...
export default function TeacherDashboard() {
  ...
  const firstName = user?.teacher?.firstName ?? user?.email ?? 'Öğretmen';
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            <View>
              ...
              <Text style={styles.role}>Öğretmen Paneli</Text>
            </View>
          ...
          <View style={styles.profileCard}>
            ...
            <View style={styles.profileInfo}>
              ...
              <View style={styles.roleBadge}>
                <Text style={styles.roleBadgeText}>Öğretmen</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.menuGrid}>
            <MenuItem icon="🏫" label="Sınıflarım" color="#dbeafe" />
            <MenuItem icon="📝" label="Testlerim" color="#dcfce7" />
            <MenuItem icon="❓" label="Sorularım" color="#fef9c3" />
            <MenuItem icon="📊" label="İstatistikler" color="#fce7f3" />
            <MenuItem icon="➕" label="Test Oluştur" color="#ede9fe" />
...
const styles = StyleSheet.create({
  ...
  roleBadgeText: { fontSize: 12, fontWeight: '600', color: '#16a34a' },
  sectionTitle: {
    fontSize: 16,
    fontWeight: '700',
